...
public class TaskManagerApplication extends Application {
    ...
    private void loadTasks() {
        ...
        Cursor tasksCursor = database.query(TASKS_TABLE,
                new String[] {TASK_ID, TASK_WHAT, TASK_WHERE, TASK_COMPLETE},
                null, null, null, null, String.format("%s,%s,%s", TASK_COMPLETE, TASK_WHAT, TASK_WHERE));
        ...
        if (! tasksCursor.isAfterLast()) {
            do {
                ...
                String what = tasksCursor.getString(1);
                String where = tasksCursor.getString(2);
                String boolValue = tasksCursor.getString(3);
                boolean complete = Boolean.parseBoolean(boolValue);
                t = new Task(what, where);
                t.setId(id);
    ...
    public void addTask(Task t) {
        ...
        values.put(TASK_WHERE, t.getWhat());
